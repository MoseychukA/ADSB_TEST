...
public:
    ...
    //static const uint16_t kMaxNumDemodStateMachines = 1;
    //uint16_t r1090_pulses_pins[kMaxNumDemodStateMachines] = { 19};
    //uint16_t r1090_demod_pins[kMaxNumDemodStateMachines] = { 20};
    //uint16_t r1090_recovered_clk_pins[kMaxNumDemodStateMachines] = { 21 }; // Установить RECOVERED_CLK на фальшивый вывод для детектора преамбулы высокой мощности. Будет переопределено
