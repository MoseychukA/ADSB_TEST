...
bool ADSBee::Update() 
{
    uint32_t timestamp_ms = millis();//!! millis();
...
void ADSBee::StartTLLearning(uint16_t tl_learning_num_cycles, uint16_t tl_learning_start_temperature_mv, uint16_t tl_min_mv, uint16_t tl_max_mv) 
{
