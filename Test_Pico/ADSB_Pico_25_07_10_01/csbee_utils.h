...
* @param[in] aircraft Объект Aircraft для выгрузки содержимого.
* @retval Количество символов, записанных в строковый буфер, или отрицательное значение, если что-то пошло не так.
*/
