...
public:
    ...
    /**
    * Укажите протокол отчетов для данного последовательного интерфейса.
    * @param[in] iface SerialInterface для установки протокола отчетов.
    * @param[in] protocol Протокол отчетов для установки на iface.
    * @retval True, если успешно, false в противном случае.
    */
