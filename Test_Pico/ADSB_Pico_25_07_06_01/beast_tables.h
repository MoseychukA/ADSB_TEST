// Ётот файл автоматически сгенерирован generate_beast_tables.py.
...
// “аблица, котора€ сопоставл€ет 60 значений RSSI с соответствующими им значени€ми в виде байта dBFS Mode S Beast.
