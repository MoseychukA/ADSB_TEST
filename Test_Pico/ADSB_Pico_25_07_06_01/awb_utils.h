...
/**
* Утилиты, извлеченные из кода проверки NASA CPR, чтобы обеспечить преобразование из представления с плавающей точкой
* позиций в альтернативное взвешенное двоичное представление, представление с фиксированной точкой, используемое библиотекой декодера CPR.
*/
...
/**
* Преобразовать альтернативную взвешенную бинарную широту в представление с плавающей точкой.
* @param[in] awb_lat Альтернативная взвешенная бинарная широта для преобразования.
* @return Представление широты с плавающей точкой в ​​градусах.
*/
